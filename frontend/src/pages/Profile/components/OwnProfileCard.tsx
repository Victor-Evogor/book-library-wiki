...
const OwnProfileCard:FunctionComponent<OwnProfileCardType> = ({ user }) => {
  ...
  return (
    <div className="rounded-md border bg-stone-950 bg-opacity-40 p-6">
      <div
