...
import ButtonLoadingSpinner from "./ButtonLoaderSpinner";
...
interface ProfileUpdateModalPropsType{
    isOpen: boolean,
...
const ProfileUpdateModal: FunctionComponent<ProfileUpdateModalPropsType> = ({ user, isOpen, onClose }) => {
